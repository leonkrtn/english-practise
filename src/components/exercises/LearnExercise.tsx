...
export default function LearnExercise({ item, onAnswered, onNext }: ExerciseProps) {
  ...
  return (
    <>
      <Badge className="h-auto inline-flex items-center gap-1 self-start rounded-full px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide mb-4 text-white shadow-sm bg-gradient-to-r from-green to-green-dark">
      ...
      <div className="bg-gradient-to-br from-blue-lighter to-purple-light/40 rounded-xl p-4 text-sm leading-relaxed text-ink-soft">
